...
public class DiceTrayGRADINGTest {
	...
	private char[][] randChars = { { 'R', 'E', 'D', 'M' },
			{ 'B', 'A', 'N', 'O' }, { 'T', 'Q', 'D', 'F' },
			{ 'L', 'O', 'E', 'V' } };

	private char[][] longWord = { { 'A', 'B', 'S', 'E' },
			{ 'I', 'M', 'T', 'N' }, { 'N', 'D', 'E', 'D' },
			{ 'S', 'S', 'E', 'N' } };
	...
	private String randBrd1String = newline + "REDM" + newline + "BANO"
			+ newline + "TQDF" + newline + "LOEV";
	...
	public void testBlatantlyNotThere() {
		System.out.println(searchBoard(repeatsBrd, "PIZZA"));
		assertFalse("Should not be able to find 'PIZZA' in" + repeatsBrdString,
				searchBoard(repeatsBrd, "PIZZA"));
		assertFalse(
				"Should not be able to find 'PUDDING' in" + repeatsBrdString,
	...
	private char[][] c = { { 'A', 'B', 'C', 'D' }, { 'E', 'F', 'G', 'H' },
			{ 'I', 'J', 'K', 'L' }, { 'M', 'N', 'O', 'P' } };
	...
	public void testStringFindWhenThereStartingInUpperLeftCorner4() {
		DiceTray b = new DiceTray(c);
		assertTrue("Could not find 'ABCDHGFEIJKLPONM' in" + cString,
				b.found("ABCDHGFEIJKLPONM"));
		assertTrue("Could not find 'ABCDHLPOKJNMIEFG' in" + cString,
				b.found("ABCDHLPOKJNMIEFG"));
	}
